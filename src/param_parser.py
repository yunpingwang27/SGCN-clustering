...
def parameter_parser():
    ...
    parser.add_argument("--truecomm-path",
                        nargs="?",
                        dest="truecomm_path",
                        default=None,
	                help="true community results.")
    parser.add_argument("--comm-path",
                        nargs="?",
                        dest="comm_path",
                        default="./output/comm.csv",
	                help="community results.")
    parser.add_argument("--outcomm-path",
                        nargs="?",
                        dest="outcomm_path",
                        default="./output/comm_2",
	                help="community results.")
